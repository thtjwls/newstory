...
CREATE TABLE newstory_list (
  ...
  category VARCHAR(20) NOT NULL comment '글 카테고리',
...
$insert_test = "
INSERT INTO newstory_list (category,subject,contents,writer,views,likes,regist,in_use,in_secret)
VALUES ('취미·유머','1번째 테스트 제목','첫번째 테스트 본문내용',1,3333,503,'now()',1,0);
INSERT INTO newstory_list (category,subject,contents,writer,views,likes,regist,in_use,in_secret)
VALUES ('취미·유머','2번째 테스트 제목','2번째 테스트 본문내용',1,3333,503,'now()',1,0);
INSERT INTO newstory_list (category,subject,contents,writer,views,likes,regist,in_use,in_secret)
VALUES ('취미·유머','3번째 테스트 제목','3번째 테스트 본문내용',1,3333,503,'now()',1,0);
INSERT INTO newstory_list (category,subject,contents,writer,views,likes,regist,in_use,in_secret)
VALUES ('취미·유머','4번째 테스트 제목','4번째 테스트 본문내용',1,3333,503,'now()',1,0);
";
